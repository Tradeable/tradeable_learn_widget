    ...
    "steps": [
      {
        ...
        "ui": [
          ...
          },
          {
            ...
            "title": "",
            "prompt":
                "Set support & resistance by dragging the given horizontal lines in the chart."
          },
          {
            "widget": "NextButtonWidget",
            "title": "Next",
            "action": "showCorrectHorizontalLines"
          }
        ],
      ...
      },
      {
        ...
        "ui": [
          ...
          },
          {
            "widget": "PlainText",
            "title": "",
            "prompt": "In the given chart what can be seen?"
          },
          {
            "widget": "MCQQuestion",
            "title": "",
            "format": "grid",
            "options": ["Breakout", "Breakdown"],
            "correctResponse": ["Breakout"]
          },
          {
            "widget": "NextButtonWidget",
            "title": "Next",
      ...
      },
      {
        ...
        "ui": [
          ...
          },
          {
            "widget": "PlainText",
            "title": "",
            "prompt": "Volume can be seen higher or lower?"
          },
          {
            "widget": "MCQQuestion",
            "title": "",
        ...
        "ui": [
          {
            ...
            "title": "",
            "prompt":
                "Breakout/ breakdown Strategy: If a stock breaks through a significant price level (eg., a resistance and support level) with high volume, it's considered a strong signal that the price will continue in that direction."
          },
          {
            "widget": "HorizontalLineChart",
            "chart": {
      ...
      },
      {
        ...
        "ui": [
          ...
          {
            "widget": "VolumePriceSlider",
            "title": "Volume",
            "prompt":
                "Move slider to understand relationships between volume and price movement",
            "textData": [
              {
                "volume": "High Bullish Volume",
                "price": "Rising Price",
                "interpretation":
                    "Strong buying momentum likely to continue pushing prices higher."
              },
              {
                "volume": "Low Overall Volume",
                "price": "SideWays",
                "interpretation":
                    "Lack of strong buying or selling interest, likely leading to price consolidation or a range-bound market"
              },
              {
                "volume": "High Bearish Volume",
                "price": "Falling Price",
                "interpretation":
                    "Strong selling pressure likely to continue driving prices lower."
              }
            ],
            "candles": [
              {
