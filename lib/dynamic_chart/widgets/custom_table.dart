    ...
    return InfoContainerBg(
      child: Column(
        ...
        children: [
          ...
          if (expanded) _buildTableBlock(context, table, colors, textStyles),
        ...
        children: [
          Container(
            decoration: BoxDecoration(
              ...
              border: Border.all(color: colors.tableBorderColor, width: 1.5),
            ),
            child: ClipRRect(
              ...
              child: SingleChildScrollView(
                ...
                child: Table(
                  ...
                  border: const TableBorder(
                    ...
                    verticalInside: BorderSide(color: Colors.grey, width: 0),
                  ),
                  children: [
      ...
      children: List.generate(table.columns.length, (colIdx) {
        return Container(
          decoration: BoxDecoration(
              ...
              border: Border(
                  bottom: BorderSide(color: colors.axisColor, width: 1.2),
                  left: colIdx != 0
                      ? BorderSide(color: colors.axisColor, width: 1.2)
                      : BorderSide.none)),
            ...
            decoration: BoxDecoration(
                ...
                border: Border(
                    left: colIdx != 0
                        ...
                        : BorderSide.none,
                    bottom: BorderSide(color: colors.optionChainStrokeColor))),
