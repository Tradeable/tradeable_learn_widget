      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border(bottom: BorderSide(color: colors.sahiTabBorder)),
          ),
          child: Row(
            children: [
              Text(
              ...
              IconButton(
                ...
                icon: Icon(Icons.close,
                    size: 20, color: colors.sahiPrimaryTextColor),
                tooltip: 'Close',
              ),
            ],
          ),
              ...
              ...tasks.map((t) {
                ...
                return Card(
                  ...
                  child: ExpansionTile(
                    ...
                    title: Text(
                      t.title,
                      style: TextStyle(color: colors.sahiPrimaryTextColor),
                    ),
                    iconColor: colors.sahiPrimaryTextColor,
                    collapsedIconColor: colors.sahiPrimaryTextColor,
